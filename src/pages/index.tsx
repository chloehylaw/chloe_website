  ...
  return (
    <>
      ...
      <div className={`${isDark ? 'dark' : ''}`}>
        ...
        <div className="pt-40 p-20 dark:bg-gray-800 min-h-screen dark:text-white">
          <div className="flex flex-wrap justify-center">
            ...
            <div className="flex flex-col lg:ml-20">
              <div className="border-2 rounded-lg p-5 space-y-2 mt-10">
                ...
                <p>
                  My name is Chloe and I&apos;m a third year software
                  engineering student from Canada. Here is some info about me!
                </p>
                <p>⚡ Work experience:</p>
